...
*Last updated: 12 July 2026. Lives in `bridge-hub` repo — see [infra-decision.md](../infra-decision.md).*
...
**SEO + AI discoverability:** Dev implementation complete — metadata, sitemap, robots, `llms.txt`, JSON-LD. Caroline checklist (Search Console, domain env) remains for launch.

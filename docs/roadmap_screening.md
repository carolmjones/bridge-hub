# Screening roadmap — assessment, scoring, results, booking

> Ordered build plan for the screening funnel (`/begin` → `/assessment` → `/results` → `/book`).
> Aligned with START_HERE build order and ARCHITECTURE.md.
> Last updated: June 2026

**Marketing pages** (`/`, `/bridge-map`, etc.) are a separate workstream — see [roadmap_marketing.md](roadmap_marketing.md).
...
- [screening/README.md](screening/README.md) — screening doc index
- [roadmap_marketing.md](roadmap_marketing.md) — marketing pages (separate workstream)
